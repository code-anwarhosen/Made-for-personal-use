    ...
    def __init__(self, *args,
        ...
        try:
            ...
            if sys.platform.startswith("win"):
                ...
                self.after(200, lambda: self.iconbitmap(os.path.join(customtkinter_directory, "assets", "icons", "logo.ico")))
        except Exception:
            pass
    ...
    def _windows_set_titlebar_icon(self):
        try:
            ...
            if not self._iconbitmap_method_called:
                customtkinter_directory = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
                self.iconbitmap(os.path.join(customtkinter_directory, "assets", "icons", "logo.ico"))
        except Exception:
            pass
